...
function App() {
    ...
    const [pageClassType, setPageClassType] = useState('')
...
useEffect(() =>{
    if (currentUrl == "/" ) {setPageClassType("page")}
    else if (currentUrl == '/experience') {setPageClassType('page__experience')}
    else if (currentUrl == '/team') {setPageClassType('page__team')}
    console.log('App',currentUrl, pageClassType )
},[currentUrl])
...
// const pageClassType =(
//     `${ isExperience ? 'page__experience' : 'page'}`
//     );
